...
public class Main {
    ...
    public static void test(){
        System.out.println("test1 {1, 1, 1, 1, 1, 1, 1} ответ: " + SearchMinimum2(test1()));
        System.out.println("test2 {1,2,3,4,5,6,7} ответ: " + SearchMinimum2(test2()));
        System.out.println("test3 {55,432,999,2,44,29} ответ: " + SearchMinimum2(test3()));
        System.out.println("test4 {2,1,2,1,2,22,2,3} ответ: " + SearchMinimum2(test4()));
    }
    ...
    public static int[ ] test4() {
        return new int[]{2,1,2,1,2,22,2,3};
    }
}
